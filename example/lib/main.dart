    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          FlutterGauge(handSize: 30,width: 40,index: 65.0,fontFamily: "Iran",end: 100,number: Number.endAndCenterAndStart,secondsMarker: SecondsMarker.secondsAndMinute,counterStyle: TextStyle(color: Colors.black,fontSize: 25,)),
        ],
      ),
    );
  }
